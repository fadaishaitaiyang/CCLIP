...
if __name__ == "__main__":
    ...
    if train_mode==1:
        if not os.path.exists('/remote-home/cs.iot.cdz/gaze/data/logsReal/'):
            os.mkdir('/remote-home/cs.iot.cdz/gaze/data/logsReal/')
        loss_history=LossHistory("/remote-home/cs.iot.cdz/gaze/data/logsReal/")
