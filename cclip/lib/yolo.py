...
class YOLO(object):
    _defaults = {
        ...
        "model_path": '/remote-home/cs_iot_szy/gaze/data/best_det_58.38/ep096-loss0.646-val_loss0.458.pth',
        # "model_path": '/remote-home/cs_iot_szy/gaze/GOO-real ep100-loss0.374-val_loss0.359.pth',
