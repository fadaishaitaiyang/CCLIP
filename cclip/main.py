...
from lib.nets.cclip import CClip
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_dir', type=str, default='/remote-home/cs_iot_szy/gaze/data/goo_dataset/gooreal/train_data/')
    parser.add_argument('--train_annotation', type=str, default='/remote-home/cs_iot_szy/gaze/data/goo_dataset/gooreal/train.pickle')
    parser.add_argument('--test_dir', type=str, default='/remote-home/cs_iot_szy/gaze/data/goo_dataset/gooreal/test_data/')
    parser.add_argument('--test_annotation', type=str, default='/remote-home/cs_iot_szy/gaze/data/goo_dataset/gooreal/test.pickle')
    ...
    # --------------------------------------------------------#
    classes_path = '/remote-home/cs_iot_szy/gaze/data/anchors/voc_classes.txt'
    # ---------------------------------------------------------------------#
    ...
    # ---------------------------------------------------------------------#
    if train_mode==0:
        anchors_path = '/remote-home/cs_iot_szy/gaze/data/anchors/yolo_anchors.txt'
        anchors_mask = [[0, 1, 2]]
    if train_mode==1:
        anchors_path = '/remote-home/cs_iot_szy/gaze/data/anchors/yolo_anchors_3.txt'
    ...
    #   Create the model
    # ------------------------------------------------------#
    model = CClip(anchors_mask, num_classes,train_mode)
    ...
    if train_mode == 0:
        if not os.path.exists('/remote-home/cs_iot_szy/gaze/data/logsSynth_1/'):
            os.mkdir('/remote-home/cs_iot_szy/gaze/data/logsSynth_1/')
        loss_history = LossHistory("/remote-home/cs_iot_szy/gaze/data/logsSynth_1/")
    if train_mode==1:
        if not os.path.exists('/remote-home/cs_iot_szy/gaze/data/logsReal/'):
            os.mkdir('/remote-home/cs_iot_szy/gaze/data/logsReal/')
        loss_history=LossHistory("/remote-home/cs_iot_szy/gaze/data/logsReal/")
    ...
    if True:
        ...
        if Freeze_Train:
            ...
            for param in model.context_decoder.parameters():
                param.requires_grad = False
